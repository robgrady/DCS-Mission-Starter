...
story += [
    ...
    P("Decide exactly how your fields are dressed. The <b>fill slider</b> sets exactly what "
      ...
      "is light, and never clutters your radar; its facing is exact where the field "
      "has a measured parking heading on file (Nellis, for one) and a best-effort guess "
      "elsewhere. "
